...
<span lang="en">Screenshot coming soon</span>
<span lang="fr">Capture d'écran à venir</span>
</div>
...
<span lang="en">WYSIWYG Markdown editor with citation autocomplete. Export to PDF (via LaTeX) or Word (.docx).</span>
<span lang="fr">Éditeur Markdown WYSIWYG avec auto-complétion des citations. Export en PDF (via LaTeX) ou Word (.docx).</span>
</li>
